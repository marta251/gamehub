...
class Wordle:
    ...
    def reinitialize_after_single_iteration(self) -> tuple:
        ...
        return characters, void_guessed_word
    ...
    def gameloop(self, stdscr : object) -> None:
        ...
        while not game_stopped:
            characters, void_guessed_word = self.reinitialize_after_single_iteration()
